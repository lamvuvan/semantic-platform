# Summary
A semantic layer on top of data platform, which utilizing product 360, merchant 360 and classified product to provide rich context and semantic of data for AI agents.

# Knowledge Graph — AI Agent Integration Architecture

**Phạm vi:** Thiết kế kiến trúc và tool layer để AI Agents truy cập Knowledge Graph KiotViet một cách an toàn, có observability, và scale được.
...
└────────────────────────────┬────────────────────────────────────┘
                             │  MCP protocol (Streamable-HTTP/JSON-RPC over SSE)
                             ▼
┌─────────────────────────────────────────────────────────────────┐
